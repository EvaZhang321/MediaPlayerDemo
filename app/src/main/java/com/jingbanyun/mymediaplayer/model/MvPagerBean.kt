...
data class VideosBean(
        ...
        var hdUrl: String, var uhdUrl: String, var shdUrl: String, var videoSize: Long,
        var hdVideoSize: Long,var uhdVideoSize: Long, var shdVideoSize: Long, var duration: Int,
