	...
	private void playVideo(Integer Media) {
		...
		try {
			...
			case LOCAL_VIDEO:
				...
				/*
				 * TODO: Set the path variable to a local media file pa				 */
				path = new File(Environment.getExternalStorageDirectory(),"DCIM/Camera/VID_20170525_204452.mp4").getAbsolutePath();
				if (path == "") {
